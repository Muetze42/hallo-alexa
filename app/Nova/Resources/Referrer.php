    ...
    public function fields(Request $request): array
    {
        return [
            Text::make(__('Url'), 'url', function () {
                return '<a href="'.e($this->url).'" class="'.config('site.nova.external_link_class').'" rel="noopener noreferrer" target="_blank">'.e($this->url).'</a><i class="'.config('site.nova.external_link_icon').'"></i>';
            })->sortable()->asHtml(),
